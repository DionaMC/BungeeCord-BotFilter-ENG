...
public class BungeeCordLauncher
{
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        bungee.getLogger().log( Level.WARNING, "Enabled BungeCord BotFilter-ENG {0} from https://github.com/LoyisaStinks/BungeeCord-BotFilter-ENG", bungee.getGameVersion() ); //BotFilter
        bungee.start();
